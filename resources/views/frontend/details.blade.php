...
@section('main-content')
			...
			<div class="featured-slick">
				<div class="featured-slick-slide">
					<div><a href="frontend/assets/img/g-1.jpg" class="mfp-gallery"><img src="frontend/assets/img/g-1.jpg" class="img-fluid mx-auto" alt="" /></a></div>
					<div><a href="frontend/assets/img/g-2.jpg" class="mfp-gallery"><img src="frontend/assets/img/g-2.jpg" class="img-fluid mx-auto" alt="" /></a></div>
					<div><a href="frontend/assets/img/g-3.jpg" class="mfp-gallery"><img src="frontend/assets/img/g-3.jpg" class="img-fluid mx-auto" alt="" /></a></div>
					<div><a href="frontend/assets/img/g-4.jpg" class="mfp-gallery"><img src="frontend/assets/img/g-4.jpg" class="img-fluid mx-auto" alt="" /></a></div>
				</div>
			</div>
								...
								<div class="reviews-comments-wrap">
									...
									<div class="reviews-comments-item">
										<div class="review-comments-avatar">
											<img src="frontend/assets/img/user-1.jpg" class="img-fluid" alt=""> 
										</div>
										<div class="reviews-comments-item-text">
											<h4><a href="tour-detail.html#">Josaph Manrty</a><span class="reviews-comments-item-date"><i class="ti-calendar theme-cl"></i>27 Oct 2019</span></h4>
											...
											<div class="pull-left reviews-reaction">
												<a href="tour-detail.html#" class="comment-like active"><i class="ti-thumb-up"></i> 12</a>
												<a href="tour-detail.html#" class="comment-dislike active"><i class="ti-thumb-down"></i> 1</a>
												<a href="tour-detail.html#" class="comment-love active"><i class="ti-heart"></i> 07</a>
											</div>
										</div>
									</div>
									...
									<div class="reviews-comments-item">
										...
										<div class="reviews-comments-item-text">
											<h4><a href="tour-detail.html#">Rita Chawla</a><span class="reviews-comments-item-date"><i class="ti-calendar theme-cl"></i>2 Nov May 2019</span></h4>
									...
									<div class="reviews-comments-item">
										...
										<div class="reviews-comments-item-text">
											<h4><a href="tour-detail.html#">Adam Wilsom</a><span class="reviews-comments-item-date"><i class="ti-calendar theme-cl"></i>10 Nov 2019</span></h4>
						...
						<div class="col-lg-4 col-md-12 col-sm-12 order-lg-2 order-md-1 order-1">
							...
							<div class="side-booking-wrap over-top radius-0">
								<div class="side-booking-header">
									<span>Price</span>
									<h3 class="price">$710<sub>night</sub></h3>
								</div>
										...
										<div class="col-lg-12 col-md-12 col-sm-12">
											<div class="stbooking-footer mt-2">
												<div class="form-group mb-0 pb-0">
													<a href="tour-detail.html#" class="btn full-width btn-theme">Request TO Book</a>
												</div>
											</div>
										</div>
									</div>
							...
							<div class="page-sidebar">
								...
								<div class="agent-widget">
									<div class="agent-title">
										<div class="agent-photo"><img src="frontend/assets/img/user-3.jpg" alt=""></div>
										<div class="agent-details">
											<h4><a href="https://kumarpreet.com/travlio-live/travlio/author-detail.html">Kajal Shreekesh</a></h4>
