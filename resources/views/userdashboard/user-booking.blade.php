...
<html lang="zxx">
    ...
    <body class="orange-skin">
        ...
        <div id="main-wrapper">
				...
				<div class="container">
					<nav id="navigation" class="navigation navigation-landscape">
						<div class="nav-header">
							<a class="nav-brand" href="my-booking.html#">
						...
						<div class="nav-menus-wrapper" style="transition-property: none;">
							<ul class="nav-menu">
								...
								<li><a href="JavaScript:Void(0);">Browse<span class="submenu-indicator"></span></a>
									<ul class="nav-dropdown nav-submenu">
										<li><a href="my-booking.html#">Tour Listing<span class="submenu-indicator"></span></a>
											<ul class="nav-dropdown nav-submenu">
							...
							<div class="dashboard-navbar">
								...
								<div class="d-navigation">
									<ul>
										...
										<li class="active"><a href="my-booking.html"><i class="ti-layers"></i>My Booking</a></li>
										<li><a href="bookmark-list.html"><i class="ti-heart"></i>Saved Items</a></li>
										<li><a href="change-password.html"><i class="ti-unlock"></i>Change Password</a></li>
										<li><a href="my-booking.html#"><i class="ti-power-off"></i>Log Out</a></li>
									</ul>
								</div>
								...
								<div class="dashboard-gravity-list">
									...
									<ul>
											...
											<div class="list-box-listing bookings">
												...
												<div class="list-box-listing-content">
													<div class="inner">
														...
														<a href="my-booking.html#small-dialog" class="rate-review"><i class="ti-email"></i> Send Message</a>

													</div>
												</div>
											</div>
											<div class="buttons-to-right">
												<a href="my-booking.html#" class="button gray reject"><i class="ti-close"></i> Reject</a>
												<a href="my-booking.html#" class="button gray approve"><i class="ti-trash"></i> Approve</a>
											</div>
										</li>
										...
										<li class="approved-booking">
											...
											<div class="buttons-to-right">
												<a href="my-booking.html#" class="button gray reject"><i class="ti-trash"></i> Cancel</a>
											</div>
										</li>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-md-3">
								<div class="footer-widget">
									...
									<div class="footer-add">
										<p><strong>Email:</strong></br><a href="my-booking.html#">hello@workstock.com</a></p>
										<p><strong>Call:</strong></br>91 855 742 62548</p>
										<ul class="footer-bottom-social mt-2">
											<li><a href="my-booking.html#"><i class="ti-facebook"></i></a></li>
											<li><a href="my-booking.html#"><i class="ti-twitter"></i></a></li>
											<li><a href="my-booking.html#"><i class="ti-instagram"></i></a></li>
											<li><a href="my-booking.html#"><i class="ti-linkedin"></i></a></li>
										</ul>
									</div>
							...
							<div class="col-lg-2 col-md-3">
								<div class="footer-widget">
									...
									<ul class="footer-menu">
										...
										<li><a href="my-booking.html#">Browse Candidates</a></li>
										<li><a href="my-booking.html#">Browse Employers</a></li>
										<li><a href="my-booking.html#">Advance Search</a></li>
										<li><a href="my-booking.html#">Job With Map</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="col-lg-2 col-md-3">
								<div class="footer-widget">
									...
									<ul class="footer-menu">
										<li><a href="my-booking.html#">Home Page 2</a></li>
										<li><a href="my-booking.html#">Home Page 3</a></li>
										<li><a href="my-booking.html#">Home Page 4</a></li>
										<li><a href="my-booking.html#">Home Page 5</a></li>
										<li><a href="my-booking.html#">LogIn</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="col-lg-2 col-md-3">
								<div class="footer-widget">
									...
									<ul class="footer-menu">
										<li><a href="my-booking.html#">Dashboard</a></li>
										<li><a href="my-booking.html#">Applications</a></li>
										<li><a href="my-booking.html#">Packages</a></li>
										<li><a href="my-booking.html#">resume.html</a></li>
										<li><a href="my-booking.html#">SignUp Page</a></li>
									</ul>
								</div>
							</div>
							...
							<div class="col-lg-3 col-md-12">
								<div class="footer-widget">
									...
									<a href="my-booking.html#" class="other-store-link">
					...
					<div class="modal-content" id="registermodal">
						...
						<div class="modal-body">
							...
							<div class="social-login mb-3">
								<ul>
									<li><a href="my-booking.html#" class="btn connect-fb"><i class="ti-facebook"></i>Facebook</a></li>
									<li><a href="my-booking.html#" class="btn connect-twitter"><i class="ti-twitter"></i>Twitter</a></li>
								</ul>
							</div>
							<div class="text-center">
								<p class="mt-5"><a href="my-booking.html#" class="link">Forgot password?</a></p>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="modal-dialog modal-dialog-centered login-pop-form" role="document">
					<div class="modal-content" id="sign-up">
						...
						<div class="modal-body">
							...
							<div class="text-center">
								<p class="mt-5"><i class="ti-user mr-1"></i>Already Have An Account? <a href="my-booking.html#" class="link">Go For LogIn</a></p>
							</div>
						</div>
					</div>
				</div>
			...
			<a id="back2Top" class="top-scroll" title="Back to top" href="my-booking.html#"><i class="ti-arrow-up"></i></a>
